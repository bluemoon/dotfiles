...
(let ((monokai-blue-light "#89BDFF")
      ...
      (monokai-caret "#F8F8F8")
      (monokai-highlight "#333333")
  ...
  (custom-theme-set-faces
   'monokai-dark-soda
   ;; Frame
   `(default ((t (:foreground ,monokai-yellow-light :background ,monokai-gray-blue))))
   `(cursor ((t (:foreground ,monokai-caret))))
   `(hl-line ((t (:background ,monokai-highlight))))
   ...
   `(fringe ((t (:background, monokai-gray-blue))))
